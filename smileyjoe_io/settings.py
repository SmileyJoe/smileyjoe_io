"""
Django settings for smileyjoe_io project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'secret.localhost', '178.128.11.228']
...
WSGI_APPLICATION = 'smileyjoe_io.wsgi.application'
